...
int main()
{
    ifstream infile; infile.open("mp6in.txt"); //open the file
    char board[ROWS][COLS]; char num; char ch; int f; //setup the array and number for adding and the gettin of the commands
